...
class SinglyCircularLinkedList {
    ...
    public void display() {
        ...
        if (head == null) {
            ...
            do {
                System.out.println(current.data.chassisNo + " " +current.data.nameOfVehicle + " " + current.data.color + " " + current.data.ownerName);
...
public class Program5 {
    public static void main(String[] args) {
        ...
        l.add(new Vehicle(4, "Honda", "Maroon", "Lisa")); //Adding one detail at the last of the list
